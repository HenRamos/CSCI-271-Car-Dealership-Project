...
using namespace std;
/*
This file is so that I can add changes to the otherwise functioning main.cpp for testing purposes.
*/
int main() {
...
while(isShopOpen){
  ...
  if(isToyota){ //menu formatting below
    for(int model = 0; model <= 5; model++){
      cout << setw(2) << 1 + model << setw(20) << Toyota[model + 1] << "\n";
    }
    ...
    for(int model = 0; model <= 5; model++){
      cout << setw(2) << 1 + model << setw(20) << Nissan[model + 1] << "\n";
  }
    cout << "Please select a model by number: \n";
    cin >> userModelChoice;
  ...
  for(int model = 0; model <= 5; model++){
    cout << setw(2) << 1 + model << setw(20) << Ford[model + 1] << "\n";
  }
  cout << "Please select a model by number: \n";
  cin >> userModelChoice;
